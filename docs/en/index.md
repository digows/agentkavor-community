...
# Build with agents without losing the engineering

Kavor is the local-first system around coding agents. Use one visual Workspace to connect the questions, context,
Specifications, files, CodingAgents, Terminals, evidence, and decisions that make software work durable.
...
Kavor is free and available for Windows, macOS, and Linux.
[Download Kavor](https://download.agentkavor.com/en) or browse the [release notes](./release-notes/index.md).

## Get help and shape Kavor

Ask a question, share a real workflow, or propose what Kavor should connect next in the
